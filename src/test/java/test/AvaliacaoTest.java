...
public class AvaliacaoTest extends BaseTest {
    ...
    public void testCriarAvaliacao() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.gerarAvaliacaoValida(710, 904);
    ...
    public void testCriarAvaliacaoSemIdDeEstadiario() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.gerarAvaliacaoComIdInvalido(0, 0);
        var response = avaliacaoService.criarAvaliacao(avaliacaoModel)
...
//region ATUALIZAR AVALIACAO
    ...
    public void testAtualizarAvaliacao() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.alterarAvaliacao(710, 904);
        AvaliacaoModel criarAvaliacao = avaliacaoService.criarAvaliacao(avaliacaoModel).extract().as(AvaliacaoModel.class);
    ...
    public void testAtualizarAvaliacaoSemIdDeAcompanhamento() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.alterarAvaliacao(-456, 904);
...
//    region BUSCAR AVALIACAO PELO ID DO ACOMPANHAMENTO
    ...
    public void testBuscarAvaliacaoComIdErrado() {
        AvaliacaoModel avaliacao = AvaliacaoDataFactory.buscarAvaliacaoComIdInvalido();
...
//region BUSCAR AVALIACAO PELO ID DA AVALIACAO
    ...
    public void testBuscarAvaliacaoPeloIdDaAvaliacao() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.gerarAvaliacaoValida(710, 904);
        AvaliacaoModel avaliacaoCriada = avaliacaoService.criarAvaliacao(avaliacaoModel).extract().as(AvaliacaoModel.class);
    ...
    public void testBuscarAvaliacaoPeloIdDaAvaliacaoComIdErrado() {
        AvaliacaoModel avaliacao = AvaliacaoDataFactory.buscarAvaliacaoPorIdDaAvaliacao(0);
        var response = avaliacaoService.buscarAvaliacaoPeloIdDaAvaliacao(avaliacao)
                .then()
                .statusCode(HttpStatus.SC_BAD_REQUEST)
                .contentType(ContentType.JSON)
...
//region DELETAR AVALIACAO
    ...
    public void testDeletarAvaliacaoPeloIdDaAvaliacaoComIdErrado() {
        AvaliacaoModel avaliacao = AvaliacaoDataFactory.deletarAvaliacaoComIdInvalidodaAvaliacao();
...
//region DESATIVAR AVALIACAO
    ...
    public void testDesativarAvaliacaoPeloIdDaAvaliacao() {
        AvaliacaoModel avaliacaoModel = AvaliacaoDataFactory.gerarAvaliacaoValida(710, 904);
        AvaliacaoModel avaliacaoCriar = avaliacaoService.criarAvaliacao(avaliacaoModel).extract().as(AvaliacaoModel.class);
    ...
    public void testDesativarAvaliacaoPeloIdDaAvaliacaoComIdErrado() {
        AvaliacaoModel avaliacao = AvaliacaoDataFactory.desativarAvaliacaoComIdInvalidodaAvaliacao();
